...
export class Backend implements backendInterface {
    ...
    async addInsightContent(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: Time): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addInsightContent(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllInsights(): Promise<Array<InsightContent>> {
        if (this.processError) {
            try {
    ...
    async getAllNetworkRequests(): Promise<Array<NetworkJoinRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllNetworkRequests();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPageAnalytics(): Promise<Array<PageAnalytics>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPageAnalytics();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getInsightsByCategory(arg0: string): Promise<Array<InsightContent>> {
        if (this.processError) {
            try {
                const result = await this.actor.getInsightsByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitDemoBooking(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: Time): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitDemoBooking(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitNetworkJoinRequest(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitNetworkJoinRequest(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        email: value.email,
        organization: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.organization))
    };
}
